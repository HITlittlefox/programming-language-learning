...
//        System.out.println("转成后缀表达式：" + suffix_strTemp.toString());
        System.out.println("转成后缀表达式：" + (Arrays.toString(suffix_strTemp.toArray())));
        System.out.println("转成后缀表达式：" + Arrays.toString(suffix_strTemp.toArray()).replaceAll(",", "").replace("[", "").replace("]", "").replace(" ", ""));

        String finalStr = Arrays.toString(suffix_strTemp.toArray()).replaceAll(",", "").replace("[", "").replace("]", "").replace(" ", "");
...
//        for (int i = 0; i < suffix_strTemp.toArray().length; i++) {
//            System.out.print(suffix_strTemp.toArray()[i]);
//        }
